...
@tool("Save File")
def save_file_tool(relative_path: str, content: str) -> str:
    """Save content to a file inside the workspace directory. Returns the saved path."""
    path = write_file(relative_path, content)
